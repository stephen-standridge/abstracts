...
//         expect(skyline.segments[0].subSegments.length).to.equal(1)
//         ensureFirst(skyline)
//         expect(skyline.segments[0].subSegments[0].entries.length).to.equal(1)
//         console.log('segments', skyline.segments)
//         console.log('entries', skyline.segments[0].entries)
//         console.log('subSegments', skyline.segments[0].subSegments)
//         console.log('first subSegment', skyline.segments[0].subSegments[0])
//         console.log('first subSegment entry', skyline.segments[0].subSegments[0].entries)
//         // expect(skyline.segments[0].subSegments.length).to.equal(1)
