...
/***/ function(module, exports, __webpack_require__) {
	...
	var _trees = __webpack_require__(14);

	var trees = _interopRequireWildcard(_trees);

	var _bounds = __webpack_require__(24);

	var bounds = _interopRequireWildcard(_bounds);

	var _surfaces = __webpack_require__(25);

	var surfaces = _interopRequireWildcard(_surfaces);

	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

	exports.default = { generators: generators, vector: vector, constants: constants, grids: grids, maps: maps, trees: trees, bounds: bounds, surfaces: surfaces };
	...
	var Grid = function () {
		...
		_createClass(Grid, [{
			...
			value: function get(_ref3) {
				...
				var returned = this.grid.slice(index, index + this.dimensions[2]);
				if (z) {
					return returned[z];
				}
				return returned;
			...
			key: 'set',
			value: function set(_ref5, value) {
				var _grid;
				...
				(_grid = this.grid).splice.apply(_grid, [index + count, length].concat(_toConsumableArray(toSet)));
			...
			value: function average(values) {
				...
				var sum = values.reduce(function (start, val) {
					...
					for (var i = 0, v; i < _this.dimensions[2]; i++) {
						v = val[i];
						if (v !== undefined) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _height_map = __webpack_require__(12);

	Object.keys(_height_map).forEach(function (key) {
	  if (key === "default" || key === "__esModule") return;
	  Object.defineProperty(exports, key, {
	    enumerable: true,
	    get: function get() {
	...
	var _diamond_square_height_map = __webpack_require__(13);

	Object.keys(_diamond_square_height_map).forEach(function (key) {
	  if (key === "default" || key === "__esModule") return;
	  Object.defineProperty(exports, key, {
	    enumerable: true,
	    get: function get() {
	      return _diamond_square_height_map[key];
	    }
	  });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HeightMap = function (_Grid) {
	  _inherits(HeightMap, _Grid);

	  function HeightMap(size, height_range, roughness) {
	    _classCallCheck(this, HeightMap);

	    var _this = _possibleConstructorReturn(this, (HeightMap.__proto__ || Object.getPrototypeOf(HeightMap)).call(this, size));

	    _this.roughness = roughness;
	    _this._minHeight = height_range ? height_range[0] : false;
	    _this._maxHeight = height_range ? height_range[1] : 0;
	    return _this;
	  }

	  _createClass(HeightMap, [{
	    key: 'getHeight',
	    value: function getHeight(u, v) {
	      //confvert XY to UV
	      var x1 = Math.floor(this.max * u);
	      var x2 = Math.ceil(this.max * u);
	      var y1 = Math.floor(this.max * v);
	      var y2 = Math.ceil(this.max * v);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.DiamondSquareHeightMap = undefined;
	...
	var DiamondSquareHeightMap = function (_HeightMap) {
	  _inherits(DiamondSquareHeightMap, _HeightMap);

	  function DiamondSquareHeightMap() {
	    ...
	    var roughness = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;

	    _classCallCheck(this, DiamondSquareHeightMap);

	    var size = Math.pow(2, detail) + 1;

	    var _this = _possibleConstructorReturn(this, (DiamondSquareHeightMap.__proto__ || Object.getPrototypeOf(DiamondSquareHeightMap)).call(this, size, height_range, roughness));

	    _this.max = size - 1;
	    return _this;
	  }

	  _createClass(DiamondSquareHeightMap, [{
	    key: 'generate',
	    ...
	    key: 'diamondSquare',
	    value: function diamondSquare(level) {
	      var half = level / 2,
	      ...
	      for (var _y = 0; _y <= this.max; _y += half) {
	        for (var _x4 = (_y + half) % level; _x4 <= this.max; _x4 += level) {
	          this.diamond(_x4, _y, half, this.randomNumberInRange * scale);
	        }
	      }
	    ...
	    key: 'square',
	    value: function square(x, y, level, offset) {
	      var ave = this.average([this.get([x - level, y - level]), // upper left
	    ...
	    key: 'diamond',
	    value: function diamond(x, y, level, offset) {
	      var ave = this.average([this.get([x - level, y]), // top
	    ...
	    value: function average(values) {
	      ...
	      var sum = values.reduce(function (start, val) {
	        if (val == undefined || !val.length) return start;
	        for (var i = 0, v; i < _this2.dimensions[2]; i++) {
	          v = val[i];
	          if (v !== undefined) {
	            start[i] = typeof start[i] == 'number' ? start[i] + v : v;
	            total[i] = typeof total[i] == 'number' ? total[i] + 1 : 1;
	...
	exports.DiamondSquareHeightMap = DiamondSquareHeightMap;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _space_tree = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _space_tree_node = __webpack_require__(20);
	...
	var _bounding_box = __webpack_require__(21);

	var _bounding_sphere = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tree_node = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BoundingBox = function (_Bounds) {
		...
		_createClass(BoundingBox, [{
			key: 'measurement',
			value: function measurement(dimension) {
				var _this2 = this;
			...
			key: 'extent',
			value: function extent(dimension) {
				if (dimension !== undefined) {
					if (dimension >= this.dimensions) {
						return;
					}
			...
			key: 'center',
			value: function center(dimension) {
				var _this3 = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nurb_surface = __webpack_require__(26);

	Object.keys(_nurb_surface).forEach(function (key) {
	  if (key === "default" || key === "__esModule") return;
	  Object.defineProperty(exports, key, {
	    enumerable: true,
	    get: function get() {
	      return _nurb_surface[key];
	    }
	  });
	});

	var _random_nurb_surface = __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NurbSurface = function (_Grid) {
	  _inherits(NurbSurface, _Grid);
	  ...
	  function NurbSurface() {
	    ...
	    var _ref$x = _ref.x,
	        edge_range_x = _ref$x === undefined ? [0, 0] : _ref$x,
	        _ref$y = _ref.y,
	        edge_range_y = _ref$y === undefined ? [0, 0] : _ref$y,
	        _ref$z = _ref.z,
	        edge_range_z = _ref$z === undefined ? [0, 0] : _ref$z;
	    var _ref2 = arguments[3];
	    var _ref2$x = _ref2.x,
	        center_range_x = _ref2$x === undefined ? [0, 0] : _ref2$x,
	        _ref2$y = _ref2.y,
	        center_range_y = _ref2$y === undefined ? [0, 0] : _ref2$y,
	        _ref2$z = _ref2.z,
	        center_range_z = _ref2$z === undefined ? [0, 0] : _ref2$z;

	    _classCallCheck(this, NurbSurface);

	    var _this = _possibleConstructorReturn(this, (NurbSurface.__proto__ || Object.getPrototypeOf(NurbSurface)).call(this, size[0], size[1], 4));

	    _this.degree = degree;
	    _this._edge_ranges = { x: edge_range_x, y: edge_range_y, z: edge_range_z };
	    _this._center_ranges = { x: center_range_x, y: center_range_y, z: center_range_z };
	    _this.knots = _this.uniformKnotVector();
	    return _this;
	  }

	  _createClass(NurbSurface, [{
	    key: 'basis',
	    ...
	    key: 'uniformKnotVector',
	    value: function uniformKnotVector() {
	      var knotVectors = [],
	          knotVector = void 0,
	          size = void 0,
	          degreeIndex = void 0,
	...
	exports.NurbSurface = NurbSurface;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RandomNurbSurface = function (_NurbSurface) {
	  _inherits(RandomNurbSurface, _NurbSurface);
