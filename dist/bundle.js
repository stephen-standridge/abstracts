...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SpaceTreeNode = exports.SpaceTree = undefined;
	...
	var _bounding_box = __webpack_require__(6);

	var _bounding_box2 = _interopRequireDefault(_bounding_box);

	var _bounding_sphere = __webpack_require__(8);

	var _bounding_sphere2 = _interopRequireDefault(_bounding_sphere);
	...
	var SpaceTreeNode = (function (_Node) {
		_inherits(SpaceTreeNode, _Node);

		function SpaceTreeNode(args) {
			_classCallCheck(this, SpaceTreeNode);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SpaceTreeNode).call(this, args));
	...
	var SpaceTree = (function (_Tree) {
		...
		function SpaceTree() {
			...
			var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(SpaceTree).call(this, args));

			_this2.objects = args.objects || [];
			_this2.root = new (Function.prototype.bind.apply(_bounding_box2.default, [null].concat(_toConsumableArray(args.region))))();
			_this2.minSize = args.minSize;
			return _this2;
		}
		...
		_createClass(SpaceTree, [{
			...
			value: function division(index, bBox) {
				...
				if (coordinates) return new (Function.prototype.bind.apply(_bounding_box2.default, [null].concat(_toConsumableArray(coordinates))))();
				return;
			}
		}, {
			key: 'insert',
			value: function insert(inserted) {
				var _this3 = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BoundingBox = (function (_Bounds) {
		...
		function BoundingBox(min, max) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BoundingBox).call(this));
		...
		_createClass(Bounds, [{
			...
			value: function contains(arg1, arg2) {
				...
				return center.reduce(function (bool, value, i) {
					...
					dmin = 0;
					if (value < min) dmin += Math.pow(value - min, 2);else if (value > max) dmin += Math.pow(value - max, 2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BoundingSphere = (function (_Bounds) {
		...
		function BoundingSphere(center, radius) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BoundingSphere).call(this));
